...
for subject in [1, 2]:
    for frequency_band in [("delta", True, False, False), ("alpha", False, True, False), ("beta", False, False, True)]:
        ...
        data_one_back = import_subject(subject, "oneback", delta=delta, alpha=alpha, beta=beta)
        
        classify(data_zero_back, data_one_back, f"TwoClassSub{subject}_{band_name}_zerobackOneback")
